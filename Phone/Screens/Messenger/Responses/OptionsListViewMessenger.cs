...
public partial class OptionsListViewMessenger : Control, DialogueViewBase
{
    ...
    public override void _Process(double delta)
    {
        ...
        {
            int count = boxContainer.GetChildCount();
            int countMinusOne = Math.Max(count - 1, 0);
            CustomMinimumSize = CustomMinimumSize.Lerp(new Vector2(0, count * 45 + countMinusOne * 5 + 40), (float) delta * 3);
        }
        else
        {
            CustomMinimumSize = CustomMinimumSize.Lerp(new Vector2(0, 0), (float) delta * 3);
        }
    }
